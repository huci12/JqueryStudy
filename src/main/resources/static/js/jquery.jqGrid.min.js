...
f=new
Date,g="local"!==e.p.datatype&&e.p.loadonce||"xmlstring"===e.p.datatype,h="_id_",i=e.p.xmlReader,k=[],l="local"===e.p.datatype?"local":"xml";if(g&&(e.p.data=[],e.p._index={},e.p.localReader.id=h),e.p.reccount=0,$.isXMLDoc(a)){-1!==e.p.treeANode||e.p.scroll?b=b>1?b:1:(L.call(e,!1,!1),b=1);var
o,p,q,r,s,t,u,v,w,x=$(e),y=0,z=!0===e.p.multiselect?1:0,A=0,B=!0===e.p.rownumbers?1:0,D=[],E={},F=[],M=m(n,"rowBox",!0,"jqgrow ui-row-"+e.p.direction);!0===e.p.subGrid&&(A=1,r=$.jgrid.getMethod("addSubGridCell")),i.repeatitems||(D=J(l)),s=!1===e.p.keyName?$.isFunction(i.id)?i.id.call(e,a):i.id:e.p.keyName,i.repeatitems&&e.p.keyName&&isNaN(s)&&(s=e.p.keyIndex),t=-1===String(s).indexOf("[")?D.length?function(a,b){return $(s,a).text()||b}:function(a,b){return $(i.cell,a).eq(s).text()||b}:function(a,b){return a.getAttribute(s.replace(/[\[\]]/g,""))||b},e.p.userData={},e.p.page=C($.jgrid.getXmlData(a,i.page),e.p.page),e.p.lastpage=C($.jgrid.getXmlData(a,i.total),1),e.p.records=C($.jgrid.getXmlData(a,i.records)),$.isFunction(i.userdata)?e.p.userData=i.userdata.call(e,a)||{}:$.jgrid.getXmlData(a,i.userdata,!0).each(function(){e.p.userData[this.getAttribute("name")]=$(this).text()});var
P=$.jgrid.getXmlData(a,i.root,!0);P=$.jgrid.getXmlData(P,i.row,!0),P||(P=[]);var
Q,R,S=P.length,T=0,U=[],V=parseInt(e.p.rowNum,10),W=e.p.scroll?$.jgrid.randId():1,X=$(e).find("tbody:first"),Y=!1;if(e.p.grouping&&(Y=!0===e.p.groupingView.groupCollapse,Q=$.jgrid.getMethod("groupingPrepare")),S>0&&e.p.page<=0&&(e.p.page=1),P&&S){d&&(V*=d+1);for(var
Z=$.isFunction(e.p.afterInsertRow),aa=B?m(n,"rownumBox",!1,"jqgrid-rownum"):"",ba=z?m(n,"multiBox",!1,"cbox"):"";T<S;){v=P[T],w=t(v,W+T),w=e.p.idPrefix+w,e.p.preserveSelection&&(e.p.multiselect?(R=-1!==e.p.selarrrow.indexOf(w),j=R?j+1:j):R=w===e.p.selrow);var
ca=F.length;if(F.push(""),B&&F.push(I(0,T,e.p.page,e.p.rowNum,aa)),z&&F.push(H(w,B,T,R,ba)),A&&F.push(r.call(x,z+B,T+b)),i.repeatitems){u||(u=K(z+A+B));var
da=$.jgrid.getXmlData(v,i.cell,!0);$.each(u,function(a){var
c=da[this];if(!c)return!1;q=c.textContent||c.text||"",E[e.p.colModel[a+z+A+B].name]=q,F.push(G(w,q,a+z+A+B,T+b,v,E))})}else
for(o=0;o<D.length;o++)q=$.jgrid.getXmlData(v,D[o]),E[e.p.colModel[o+z+A+B].name]=q,F.push(G(w,q,o+z+A+B,T+b,v,E));if(F[ca]=O(w,Y,M,E,v),F.push("</tr>"),e.p.grouping&&(U.push(F),e.p.groupingView._locgr||Q.call(x,E,T),F=[]),(g||!0===e.p.treeGrid&&!e.p._ald)&&(E[h]=$.jgrid.stripPref(e.p.idPrefix,w),e.p.data.push(E),e.p._index[E[h]]=e.p.data.length-1,e.p.treeANode>-1&&"adjacency"===e.p.treeGridModel&&k.push(E)),!1===e.p.gridview&&(X.append(F.join("")),x.triggerHandler("jqGridAfterInsertRow",[w,E,v]),Z&&e.p.afterInsertRow.call(e,w,E,v),F=[]),E={},y++,T++,y===V)break}}if(j=e.p.multiselect&&e.p.preserveSelection&&y===j,!0===e.p.gridview&&(p=e.p.treeANode>-1?e.p.treeANode:0,e.p.grouping?g||(x.jqGrid("groupingRender",U,e.p.colModel.length,e.p.page,V),U=null):!0===e.p.treeGrid&&p>0?$(e.rows[p]).after(F.join("")):(X.append(F.join("")),e.grid.cols=e.rows[0].cells)),e.p.totaltime=new
Date-f,F=null,y>0&&0===e.p.records&&(e.p.records=S),!0===e.p.treeGrid){try{x.jqGrid("setTreeNode",p+1,y+p+1)}catch(a){}if(e.p.treeANode>-1&&"adjacency"===e.p.treeGridModel&&(q=e.rows[e.p.treeANode].id,(q=e.p._index[q]+1)>=1)){for(e.p.data.splice(-S,S),o=0;o<S;o++)e.p.data.splice(q+o,0,k[o]);N()}}if(e.p.reccount=y,e.p.treeANode=-1,e.p.userDataOnFooter&&x.jqGrid("footerData","set",e.p.userData,e.p.formatFooterData),e.p.userDataOnHeader&&x.jqGrid("headerData","set",e.p.userData,e.p.formatHeaderData),g&&(e.p.records=S,e.p.lastpage=Math.ceil(S/V)),c||e.updatepager(!1,!0),j&&_(!0),g){for(;y<S;){if(v=P[y],w=t(v,y+W),w=e.p.idPrefix+w,i.repeatitems){u||(u=K(z+A+B));var
ea=$.jgrid.getXmlData(v,i.cell,!0);$.each(u,function(a){var
b=ea[this];if(!b)return!1;q=b.textContent||b.text||"",E[e.p.colModel[a+z+A+B].name]=q})}else
...
a,b=$(e).jqGrid("isGroupHeaderOn");if(b&&($(e).jqGrid("destroyGroupHeader",!1),a=$.extend([],e.p.groupHeader),e.p.groupHeader=null),b&&a)for(var
...
a,b=[],c=0,d=0;return this.each(function(){if((a=this.rows.length)&&a>0)for(;c<a;)$(this.rows[c]).hasClass("jqgrow")&&"norecs"!==this.rows[c].id&&(b[d]=this.rows[c].id,d++),c++}),b},setSelection:function(a,b,c,d){return this.each(function(){function
e(a){var
...
c,d=this,e=!1,f=$.jgrid.cell_width?0:d.p.cellLayout,g=!1;if(d.grid){"string"==typeof
a&&(a=[a]),b="none"!==b?"":"none";var
h=""===b,i=null,j=$(d).jqGrid("isGroupHeaderOn");if(d.p.frozenColumns&&($(d).jqGrid("destroyFrozenColumns"),g=!0),j&&($(d).jqGrid("destroyGroupHeader",!1),i=$.extend([],d.p.groupHeader),d.p.groupHeader=null),$(this.p.colModel).each(function(g){-1!==$.inArray(this.name,a)&&this.hidden===h&&($("tr[role=row]",d.grid.hDiv).each(function(){$(this.cells[g]).css("display",b)}),$(d.rows).each(function(){$(this).hasClass("jqgroup")||$(this.cells[g]).css("display",b)}),d.p.footerrow&&$("tr.footrow td:eq("+g+")",d.grid.sDiv).css("display",b),d.p.headerrow&&$("tr.hrheadrow td:eq("+g+")",d.grid.hrDiv).css("display",b),c=parseInt(this.width,10),"none"===b?d.p.tblwidth-=c+f:d.p.tblwidth+=c+f,this.hidden=!h,e=!0,$(d).triggerHandler("jqGridShowHideCol",[h,this.name,g]))}),!0===e&&(!0!==d.p.shrinkToFit||isNaN(d.p.height)||(d.p.tblwidth+=parseInt(d.p.scrollOffset,10)),$(d).jqGrid("setGridWidth",!0===d.p.shrinkToFit?d.p.tblwidth:d.p.width)),j&&i)for(var
k=0;k<i.length;k++)$(d).jqGrid("setGroupHeaders",i[k]);g&&$(d).jqGrid("setFrozenColumns")}})},hideCol:function(a){return this.each(function(){$(this).jqGrid("showHideCol",a,"none")})},showCol:function(a){return this.each(function(){$(this).jqGrid("showHideCol",a,"")})},remapColumns:function(a,b,c){function
d(b){var
...
c,d,e,f,g,h=this,i=!1,j=0,k=$.jgrid.cell_width?0:h.p.cellLayout,l=0,m=!1,n=h.p.scrollOffset,o=0,p=-1===h.p.styleUI.search("Bootstrap")||isNaN(h.p.height)?0:2;if("boolean"!=typeof
b&&(b=h.p.shrinkToFit),!isNaN(a)){if(a=parseInt(a,10),h.grid.width=h.p.width=a,$("#gbox_"+$.jgrid.jqID(h.p.id)).css("width",a+"px"),$("#gview_"+$.jgrid.jqID(h.p.id)).css("width",a+"px"),$(h.grid.bDiv).css("width",a-p+"px"),$(h.grid.hDiv).css("width",a-p+"px"),h.p.pager&&$(h.p.pager).css("width",a-p+"px"),h.p.toppager&&$(h.p.toppager).css("width",a-p+"px"),!0===h.p.toolbar[0]&&($(h.grid.uDiv).css("width",a-p+"px"),"both"===h.p.toolbar[1]&&$(h.grid.ubDiv).css("width",a-p+"px")),h.p.footerrow&&$(h.grid.sDiv).css("width",a-p+"px"),h.p.headerrow&&$(h.grid.hrDiv).css("width",a-p+"px"),d=$(h).jqGrid("isGroupHeaderOn"),d&&$(h).jqGrid("destroyGroupHeader",!1),h.p.frozenColumns&&($(h).jqGrid("destroyFrozenColumns"),i=!0),!1===b&&!0===h.p.forceFit&&(h.p.forceFit=!1),!0===b){if($.each(h.p.colModel,function(){!1===this.hidden&&(c=this.widthOrg,j+=c+k,this.fixed?o+=c+k:l++)}),0===l)return;h.p.tblwidth=j,f=a-k*l-o,isNaN(h.p.height)||($(h.grid.bDiv)[0].clientHeight<$(h.grid.bDiv)[0].scrollHeight||1===h.rows.length||"scroll"===$(h.grid.bDiv).css("overflow-y"))&&(m=!0,f-=n),j=0;var
q=h.grid.cols.length>0;if($.each(h.p.colModel,function(a){if(!1===this.hidden&&!this.fixed){if(c=this.widthOrg,(c=Math.round(f*c/(h.p.tblwidth-k*l-o)))<0)return;this.width=c,j+=c,h.grid.headers[a].width=c,h.grid.headers[a].el.style.width=c+"px",h.p.footerrow&&(h.grid.footers[a].style.width=c+"px"),h.p.headerrow&&(h.grid.hrheaders[a].style.width=c+"px"),q&&(h.grid.cols[a].style.width=c+"px"),e=a}}),!e)return;if(g=0,m?a-o-(j+k*l)!==n&&(g=a-o-(j+k*l)-n):m||0===Math.abs(a-o-(j+k*l))||(g=a-o-(j+k*l)-p),h.p.colModel[e].width+=g,h.p.tblwidth=j+g+k*l+o,h.p.tblwidth>a){var
r=h.p.tblwidth-parseInt(a,10);h.p.tblwidth=a,c=h.p.colModel[e].width=h.p.colModel[e].width-r}else
h.p.tblwidth===a?(c=h.p.colModel[e].width=h.p.colModel[e].width-p,h.p.tblwidth=a-p):c=h.p.colModel[e].width;$("table:first",h.grid.bDiv).css("width",h.p.tblwidth+"px"),$("table:first",h.grid.hDiv).css("width",h.p.tblwidth+"px"),h.grid.hDiv.scrollLeft=h.grid.bDiv.scrollLeft,h.p.footerrow&&$("table:first",h.grid.sDiv).css("width",h.p.tblwidth+"px"),h.p.headerrow&&$("table:first",h.grid.hrDiv).css("width",h.p.tblwidth+"px");var
s=$(h.grid.bDiv)[0].scrollWidth>$(h.grid.bDiv).width()&&0!==p?-1:0;c=h.p.colModel[e].width+=s,h.grid.headers[e].width=c,h.grid.headers[e].el.style.width=c+"px",q&&(h.grid.cols[e].style.width=c+"px"),h.p.footerrow&&(h.grid.footers[e].style.width=c+"px"),h.p.headerrow&&(h.grid.hrheaders[e].style.width=c+"px")}if(d){var
t=$.extend([],h.p.groupHeader);h.p.groupHeader=null;for(var
u=0;u<t.length;u++)$(h).jqGrid("setGroupHeaders",t[u]);h.grid.hDiv.scrollLeft=h.grid.bDiv.scrollLeft}i&&$(h).jqGrid("setFrozenColumns")}}})},setGridHeight:function(a,b){return this.each(function(){var
c=this;if(c.grid){b||(b=!1);var
d=$(c.grid.bDiv),e=$(c.grid.hDiv).outerHeight();!0===b&&(c.p.pager&&(e+=$(c.p.pager).outerHeight()),c.p.toppager&&(e+=$(c.p.toppager).outerHeight()),!0===c.p.toolbar[0]&&(e+=$(c.grid.uDiv).outerHeight(),"both"===c.p.toolbar[1]&&(e+=$(c.grid.ubDiv).outerHeight())),c.p.footerrow&&(e+=$(c.grid.sDiv).outerHeight()),c.p.headerrow&&(e+=$(c.grid.hrDiv).outerHeight()),c.p.caption&&(e+=$(c.grid.cDiv).outerHeight()),a>e&&(a-=e)),d.css({height:a+(isNaN(a)?"":"px")}),!0===c.p.frozenColumns&&$("#"+$.jgrid.jqID(c.p.id)+"_frozen").parent().height(d.height()-16),c.p.height=a,c.p.scroll&&c.grid.populateVisible()}})},maxGridHeight:function(a,b){return this.each(function(){var
...
k=a.p.caption?$(a.grid.cDiv).outerHeight():0,l=0,m=parseInt($(".ui-jqgrid-htable","#gview_"+$.jgrid.jqID(a.p.id)).height(),10),n=parseInt($(".ui-jqgrid-hdiv","#gview_"+$.jgrid.jqID(a.p.id)).height(),10),o=$(".ui-jqgrid-bdiv","#gview_"+$.jgrid.jqID(a.p.id)).position();a.p.toppager&&(k+=$(a.grid.topDiv).outerHeight()),!0===a.p.toolbar[0]&&"bottom"!==a.p.toolbar[1]&&(k+=$(a.grid.uDiv).outerHeight()),a.p.headerrow&&(l=parseInt($(".ui-jqgrid-hrdiv","#gview_"+$.jgrid.jqID(a.p.id)).height(),10)),a.grid.fhDiv=$('<div style="position:absolute;'+("rtl"===a.p.direction?"right:0;":"left:0;")+"top:"+k+"px;height:"+(n-j)+'px;" class="frozen-div '+g+'"></div>'),a.grid.fbDiv=$('<div style="position:absolute;'+("rtl"===a.p.direction?"right:0;":"left:0;")+"top:"+o.top+'px;overflow-y:hidden" class="frozen-bdiv ui-jqgrid-bdiv"></div>'),$("#gview_"+$.jgrid.jqID(a.p.id)).append(a.grid.fhDiv);var
p=$(".ui-jqgrid-htable","#gview_"+$.jgrid.jqID(a.p.id)).clone(!0),q=null;if($(a).jqGrid("isGroupHeaderOn")){q=$("tr.jqg-third-row-header",a.grid.hDiv).height(),$("tr.jqg-first-row-header, tr.jqg-third-row-header",p).each(function(){$("th:gt("+e+")",this).remove()});var
r,s,t=-1,u=-1;$("tr.jqg-second-row-header th",p).each(function(){if(r=parseInt($(this).attr("colspan"),10),s=parseInt($(this).attr("rowspan"),10),s&&(t++,u++),r&&(t+=r,u++),t===e)return u=e,!1}),t!==e&&(u=e),$("tr.jqg-second-row-header",p).each(function(){$("th:gt("+u+")",this).remove()})}else{var
v=[];$(".ui-jqgrid-htable tr","#gview_"+$.jgrid.jqID(a.p.id)).each(function(a,b){v.push(parseInt($(this).height(),10))}),$("tr",p).each(function(){$("th:gt("+e+")",this).remove()}),$("tr",p).each(function(a){$(this).height(v[a])})}if(0===$("tr.jqg-second-row-header th:eq(0)",p).text()&&$("tr.jqg-second-row-header th:eq(0)",p).prepend("&nbsp;"),""===$.trim($("tr.jqg-third-row-header th:eq(0)",p).text())&&$("tr.jqg-third-row-header th:eq(0) div",p).prepend("&nbsp;"),q&&$("tr.jqg-third-row-header th:eq(0)",p).height(q),$(p).width(1),$.jgrid.msie()||$(p).css("height","100%"),$(a.grid.fhDiv).append(p).mousemove(function(b){if(a.grid.resizing)return a.grid.dragMove(b),!1}),a.p.headerrow){a.grid.fhrDiv=$('<div style="position:absolute;'+("rtl"===a.p.direction?"right:0;":"left:0;")+"top:"+(parseInt(k,10)+parseInt(n,10)+1-j)+"px;height:"+(n-j)+'px;" class="frozen-hrdiv ui-jqgrid-hrdiv "></div>'),$("#gview_"+$.jgrid.jqID(a.p.id)).append(a.grid.fhrDiv);var
w=$(".ui-jqgrid-hrtable","#gview_"+$.jgrid.jqID(a.p.id)).clone(!0);$("tr",w).each(function(){$("td:gt("+e+")",this).remove()}),$(w).width(1),$(a.grid.fhrDiv).append(w)}if(a.p.footerrow){var
x=$(".ui-jqgrid-bdiv","#gview_"+$.jgrid.jqID(a.p.id)).height();a.grid.fsDiv=$('<div style="position:absolute;left:0px;top:'+(parseInt(k,10)+parseInt(m,10)+parseInt(x,10)+1-j+parseInt(l,10))+'px;" class="frozen-sdiv ui-jqgrid-sdiv"></div>'),$("#gview_"+$.jgrid.jqID(a.p.id)).append(a.grid.fsDiv);var
y=$(".ui-jqgrid-ftable","#gview_"+$.jgrid.jqID(a.p.id)).clone(!0);$("tr",y).each(function(){$("td:gt("+e+")",this).remove()}),$(y).width(1),$(a.grid.fsDiv).append(y)}$("#gview_"+$.jgrid.jqID(a.p.id)).append(a.grid.fbDiv),$(a.grid.fbDiv).on("mousewheel DOMMouseScroll",function(b){var
...
z;$(a).on("jqGridAfterGridComplete.setFrozenColumns",function(){$("#"+$.jgrid.jqID(a.p.id)+"_frozen").remove(),z=parseInt($(a.grid.bDiv)[0].scrollWidth,10)>parseInt($(a.grid.bDiv)[0].clientWidth,10),$(a.grid.fbDiv).height($(a.grid.bDiv)[0].clientHeight-(z?0:a.p.scrollOffset-3));var
b=[];$("#"+$.jgrid.jqID(a.p.id)+" tr[role=row].jqgrow").each(function(){b.push($(this).height())});var
c=$("#"+$.jgrid.jqID(a.p.id)).clone(!0);$("tr[role=row]",c).each(function(){$("td[role=gridcell]:gt("+e+")",this).remove()}),$(c).width(1).attr("id",a.p.id+"_frozen"),$(a.grid.fbDiv).append(c),$("tr[role=row].jqgrow",c).each(function(a,c){$(this).height(b[a])}),!0===a.p.hoverrows&&($("tr.jqgrow",c).hover(function(){$(this).addClass(h),$("#"+$.jgrid.jqID(this.id),"#"+$.jgrid.jqID(a.p.id)).addClass(h)},function(){$(this).removeClass(h),$("#"+$.jgrid.jqID(this.id),"#"+$.jgrid.jqID(a.p.id)).removeClass(h)}),$("tr.jqgrow","#"+$.jgrid.jqID(a.p.id)).hover(function(){$(this).addClass(h),$("#"+$.jgrid.jqID(this.id),"#"+$.jgrid.jqID(a.p.id)+"_frozen").addClass(h)},function(){$(this).removeClass(h),$("#"+$.jgrid.jqID(this.id),"#"+$.jgrid.jqID(a.p.id)+"_frozen").removeClass(h)}))}),a.grid.hDiv.loading||$(a).triggerHandler("jqGridAfterGridComplete"),a.p.frozenColumns=!0}}}})},destroyFrozenColumns:function(){return this.each(function(){if(this.grid&&!0===this.p.frozenColumns){var
...
for(j=0;j<n.length;j++)a(e).jqGrid("delRowData",e.p.idPrefix+n[j]);e.p.selrow=null,e.p.selarrrow=[]}if(a.isFunction(b[e.p.id].afterComplete)||Object.prototype.hasOwnProperty.call(a._data(a(e)[0],"events"),"jqGridDelRowAfterComplete")){var
...
t=d.p.colModel[q],u=a.extend({},t.searchoptions);for(u.sopt||(u.sopt=[],u.sopt[0]="select"===t.stype?"eq":b.defaultSearch),a.each(b.odata,function(){p.push(this.oper)}),q=0;q<u.sopt.length;q++)-1!==(i=a.inArray(u.sopt[q],p))&&(h=o===b.odata[i].oper?k.highlight:"",n+='<li class="ui-menu-item '+h+'" role="presentation"><a class="'+k.cornerall+' g-menu-item" tabindex="0" role="menuitem" value="'+b.odata[i].oper+'" oper="'+b.operands[b.odata[i].oper]+'"><table class="ui-common-table"><tr><td class="opersign">'+b.operands[b.odata[i].oper]+"</td><td>"+b.odata[i].text+"</td></tr></table></a></li>");n+="</ul>",a("body").append(n),a("#sopt_menu").addClass("ui-menu "+j.menu_widget),a("#sopt_menu > li > a").hover(function(){a(this).addClass(k.hover)},function(){a(this).removeClass(k.hover)}).click(function(){var
...
B=a.jgrid.buildButtons(b.buttons,v+t,m),C=null;if(a(d).jqGrid("isGroupHeaderOn")){var
...
q=a(d).triggerHandler("jqGridAfterSubmitCell",[d,l,y[A],m,h,b,c])||[!0,""];!0===q[0]&&a.isFunction(d.p.afterSubmitCell)&&(q=d.p.afterSubmitCell.call(d,l,y[A],m,h,b,c)),!0===q[0]?(v&&(h=""),a(k).empty(),a(d).jqGrid("setCell",d.p.savedRow[e].rowId,c,i,!1,!1,!0),k=a("td:eq("+c+")",j),a(k).addClass("dirty-cell"),a(j).addClass("edited"),a(d).triggerHandler("jqGridAfterSaveCell",[d.p.savedRow[e].rowId,m,h,b,c]),a.isFunction(d.p.afterSaveCell)&&d.p.afterSaveCell.call(d,d.p.savedRow[e].rowId,m,h,b,c),d.p.savedRow.splice(0,1)):(a(d).triggerHandler("jqGridErrorCell",[l,p]),a.isFunction(d.p.errorCell)?d.p.errorCell.call(d,l,p):a.jgrid.info_dialog(f.errcap,q[1],g.bClose,{styleUI:d.p.styleUI,top:o.top+30,left:o.left,onClose:function(){d.p.restoreCellonFail||a("#"+b+"_"+n,j).focus()}}),d.p.restoreCellonFail&&a(d).jqGrid("restoreCell",b,c))}},error:function(e,h,i){a("#lui_"+a.jgrid.jqID(d.p.id)).hide(),d.grid.hDiv.loading=!1,a(d).triggerHandler("jqGridErrorCell",[e,h,i]),a.isFunction(d.p.errorCell)?d.p.errorCell.call(d,e,h,i):a.jgrid.info_dialog(f.errcap,e.status+" : "+e.statusText+"<br/>"+h,g.bClose,{styleUI:d.p.styleUI,top:o.top+30,left:o.left,onClose:function(){d.p.restoreCellonFail||a("#"+b+"_"+n,j).focus()}}),d.p.restoreCellonFail&&a(d).jqGrid("restoreCell",b,c)}},a.jgrid.ajaxOptions,d.p.ajaxCellOptions||{}))}else
try{a.jgrid.info_dialog(f.errcap,f.nourl,g.bClose,{styleUI:d.p.styleUI}),d.p.restoreCellonFail&&a(d).jqGrid("restoreCell",b,c)}catch(a){}"clientArray"===d.p.cellsubmit&&(a(k).empty(),a(d).jqGrid("setCell",d.p.savedRow[e].rowId,c,i,!1,!1,!0),k=a("td:eq("+c+")",j),a(k).addClass("dirty-cell"),a(j).addClass("edited"),a(d).triggerHandler("jqGridAfterSaveCell",[d.p.savedRow[e].rowId,m,h,b,c]),a.isFunction(d.p.afterSaveCell)&&d.p.afterSaveCell.call(d,d.p.savedRow[e].rowId,m,h,b,c),d.p.savedRow.splice(0,1))}else
...
c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r=this,s=0,t=r.p.colModel,u=t.length,v=r.grid.headers,w=a("table.ui-jqgrid-htable",r.grid.hDiv),x=w.children("thead").children("tr.ui-jqgrid-labels:last").addClass("jqg-second-row-header"),y=w.children("thead"),z=w.find(".jqg-first-row-header"),A=!1,B=a.jgrid.styleUI[r.p.styleUI||"jQueryUI"].base;r.p.groupHeader||(r.p.groupHeader=[]),r.p.groupHeader.push(b),r.p.groupHeaderOn=!0,void
0===z[0]?z=a("<tr>",{role:"row","aria-hidden":"true"}).addClass("jqg-first-row-header").css("height","auto"):z.empty();var
C=function(a,b){var
c,d=b.length;for(c=0;c<d;c++)if(b[c].startColumnName===a)return c;return-1};for((a(document.activeElement).is("input")||a(document.activeElement).is("textarea"))&&(A=document.activeElement),a(r).prepend(y),a(r).prepend(y),e=a("<tr>",{role:"row"}).addClass("ui-jqgrid-labels jqg-third-row-header"),c=0;c<u;c++)if(g=v[c].el,h=a(g),d=t[c],i={height:"0px",width:v[c].width+"px",display:d.hidden?"none":""},a("<th>",{role:"gridcell"}).css(i).addClass("ui-first-th-"+r.p.direction).appendTo(z),g.style.width="",(j=C(d.name,b.groupHeaders))>=0){for(k=b.groupHeaders[j],l=k.numberOfColumns,m=k.titleText,o=k.className||"",n=0,j=0;j<l&&c+j<u;j++)t[c+j].hidden||n++;f=a("<th>").attr({role:"columnheader"}).addClass(B.headerBox+" ui-th-column-header ui-th-"+r.p.direction+" "+o).html(m),n>0&&f.attr("colspan",String(n)),r.p.headertitles&&f.attr("title",f.text()),0===n&&f.hide(),h.before(f),e.append(g),s=l-1}else
if(0===s)if(b.useColSpanStyle){var
D=h.attr("rowspan")?parseInt(h.attr("rowspan"),10)+1:2;h.attr("rowspan",D)}else
a("<th>",{role:"columnheader"}).addClass(B.headerBox+" ui-th-column-header ui-th-"+r.p.direction).css({display:d.hidden?"none":""}).insertBefore(h),e.append(g);else
e.append(g),s--;if(p=a(r).children("thead"),p.prepend(z),e.insertAfter(x),w.append(p),b.useColSpanStyle&&(w.find("span.ui-jqgrid-resize").each(function(){var
b=a(this).parent();b.is(":visible")&&(this.style.cssText="height: "+b.height()+"px !important; cursor: col-resize;")}),w.find("div.ui-jqgrid-sortable").each(function(){var
b=a(this),c=b.parent();c.is(":visible")&&c.is(":has(span.ui-jqgrid-resize)")&&b.css("top",(c.height()-b.outerHeight())/2-4+"px")})),q=p.find("tr.jqg-first-row-header"),a(r).on("jqGridResizeStop.setGroupHeaders",function(a,b,c){q.find("th").eq(c)[0].style.width=b+"px"}),A)try{a(A).focus()}catch(a){}""===a.trim(a("tr.jqg-second-row-header th:eq(0)").text())&&a("tr.jqg-second-row-header th:eq(0)").prepend("&nbsp;")})},destroyGroupHeader:function(b){return void
0===b&&(b=!0),this.each(function(){var
c,d,e,f,g,h,i,j=this,k=j.grid,l=a("table.ui-jqgrid-htable thead",k.hDiv),m=j.p.colModel,n=!1;if(k){for(j.p.frozenColumns&&(a(j).jqGrid("destroyFrozenColumns"),n=!0),a(this).off(".setGroupHeaders"),j.p.groupHeaderOn=!1,c=a("<tr>",{role:"row"}).addClass("ui-jqgrid-labels"),f=k.headers,d=0,e=f.length;d<e;d++){i=m[d].hidden?"none":"",g=a(f[d].el).width(a("tr.jqg-first-row-header th:eq("+d+")",l).width()).css("display",i);try{g.removeAttr("rowSpan")}catch(a){g.attr("rowSpan",1)}c.append(g),h=g.children("span.ui-jqgrid-resize"),h.length>0&&(h[0].style.height=""),g.children("div")[0].style.top=""}a(l).children("tr.ui-jqgrid-labels").remove(),a(l).children("tr.jqg-first-row-header").remove(),a(l).prepend(c),!0===b&&a(j).jqGrid("setGridParam",{groupHeader:null}),n&&a(j).jqGrid("setFrozenColumns")}})},isGroupHeaderOn:function(){var
b=this[0];return!0===b.p.groupHeaderOn&&b.p.groupHeader&&(a.isArray(b.p.groupHeader)||a.isFunction(b.p.groupHeader))}})});!function(a){"use strict";"function"==typeof
...
Array(b.collen),b.includeCaption&&i.p.caption){for(o=b.collen;--o;)g[o]="";g[0]=a.jgrid.formatCellCsv(i.p.caption,b),q+=g.join(b.separator)+b.newLine}if(b.includeGroupHeader&&a(i).jqGrid("isGroupHeaderOn")){var
...
t=w.parser[w.map[l]];if(!0===t.excel_parsers)for(var
...
in
N)N.hasOwnProperty(v)&&(N[v]=a.jgrid.stripHtml(N[v]));a.isEmptyObject(N)||(B(N,!0),a("row:last c",n).attr("s","2"))}if(k.p.grouping){var
...
in
w.footer)w.footer.hasOwnProperty(v)&&(w.footer[v]=a.jgrid.stripHtml(w.footer[v]));a.isEmptyObject(w.footer)||(B(w.footer,!0),a("row:last c",n).attr("s","2"))}var
...
s;if(b.includeGroupHeader&&a(g).jqGrid("isGroupHeaderOn"))for(s=g.p.groupHeader,m=0;m<s.length;m++){var
